...
def generate_launch_description():
    ...
    multi_nav2_share = get_package_share_directory('multi_room')
    nav2_bringup_share = get_package_share_directory('nav2_bringup')
    nav_launch_dir = os.path.join(nav2_bringup_share, 'launch')
    default_map = os.path.join(multi_nav2_share, 'maps', 'map_cart_good.yaml')
    ...
    return LaunchDescription([
        DeclareLaunchArgument('namespace', default_value='tb_205', description='Namespace for the robot'),
